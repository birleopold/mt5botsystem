...
input double EquityDrawdownLimit = 10.0;
input double Threshold           = 0.0001;
input int    MaxPositions        = 100;

//--- Inputs: Stop Loss / Take Profit
input int    SLPoints            = 10;   // 10 points stop loss
input int    TPPoints            = 30;   // 30 points take profit

//--- Inputs: Trailing Stop
input bool   UseTrailing         = true;
input double TrailingLevelPct    = 80.0;
input double TrailingActivationPts = 10.0;
