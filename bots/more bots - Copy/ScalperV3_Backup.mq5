...
input int minSecondsBetweenTrades = 1;   // Minimum seconds between trades (reduced from 2)
input double maxSpreadFactor = 0.5;      // Maximum spread as a factor of ATR (increased from 0.4)
input bool enableSpreadProtection = true; // Enable spread protection
input bool enableNewsFilter = false;      // Avoid trading during high-impact news (disabled)
