...
input int minSecondsBetweenTrades = 15;
...
input double minStopLoss = 12.0;
input double maxStopLoss = 25.0;
input double minTakeProfit = 20.0;
input double maxTakeProfit = 42.0;
input double riskRewardRatio = 1.67;
...
input double profitLockPercentage = 0.5;
input int profitCheckSeconds = 5;
input bool useTrailingTakeProfit = true;
input double tpExtensionFactor = 1.3;
input int maxTPTrailCount = 0;
input bool useVolumeSpike = false;
input bool useImbalance = false;
input bool useOrderFlow = false;
...
void OnTick() {
    ...
    switch(currentRegime) {
        ...
        case RANGING_WIDE:
            ...
            dynamicSL = currentAtr * slMultiplier;
