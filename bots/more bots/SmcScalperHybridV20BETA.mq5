...
bool TradeWithRetry(string actionType, double lots, double price, double stopLoss, double takeProfit, int maxRetries = 3) {
    ...
    tradeObj.SetDeviationInPoints(AdaptiveSlippagePoints);
    
    // Base parameters for exponential backoff
    int baseWaitMs = 50; // Start with 50ms wait
    int maxWaitMs = 1000; // Cap at 1 second
