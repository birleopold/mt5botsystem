...
// Market regime constants - IMPORTANT: must be unique integers
...
input bool   useProfitProtection = true;   // Enable profit protection mechanism
input double profitProtectionThreshold = 0.3; // Profit % threshold to activate protection (30% of original TP)
input double profitLockPercentage = 0.5;   // Percentage of current profit to lock in (50%)
input int    profitCheckSeconds = 5;       // How often to check for profit protection (seconds)
